$.fn.province_city_county = function(v_province,v_city,v_county){
    ...
    _self.html("<select id='province' name='province' class='form-control' style='width:80px;'></select>" +
            "<select id='city' name='city' class='form-control' style='width:100px;'></select>" +
            "<select id='county' name='county' class='form-control' style='width:80px;'></select>");
    //分别获取3个下拉框
